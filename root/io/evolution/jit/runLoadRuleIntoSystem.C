...
void runLoadRuleIntoSystem()
{
   ...
   vect.push_back("type=read include=\"<cmath>; <mapp>\" sourceClass=\"AliAODForwardMult\" targetClass=\"AliAODForwardMult\" source=\"UInt_t fTriggers; Float_t fIpZ; Float_t fCentrality; UShort_t fNClusters;\" target=\"fHeader\" version=\"[-5]\" code=\"{std::cout << \"ololo\" << std::endl;}\"");
